...
<div class="content-wrapper">
      ...
      <div class="row">
          ...
          <a class="btn btn-tool" href="{{route('admin.song.create')}}"> <i class="fas fa-plus"> </i> Add </a>
          ...
          <button type="button" class="btn btn-tool" data-card-widget="collapse">
				...
				<div class="card-body">
                  ...
                  <tr>
                    ...
                    <a class="btn btn-info btn-xs" href="{{ route('admin.song.edit',$dt->id) }}"><i class="fas fa-pencil-alt"> </i> Edit</a>
							      @csrf
                		</form>
                    </td>
                  </tr>
